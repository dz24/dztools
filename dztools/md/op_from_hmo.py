...
def finder(xyz):
    ...
    if not bad:
        ...
        Adist1 = distances.distance_array(xyz[0], xyz[715], box=BOX)
        Adist2 = distances.distance_array(xyz[1], xyz[715], box=BOX)
        Adist3 = distances.distance_array(xyz[0], xyz[1], box=BOX)
        AOP = (Adist1[0][0]-Adist2[0][0])/Adist3[0][0]
        # print(OP, AOP)
        return AOP, dist1[0][0], 's0', loc, bad
    else:
